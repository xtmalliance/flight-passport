...
class PassportApplication(AbstractApplication):
    APPLICATION_CLASS_CHOICES = ((0, _('Other')),(1, _('Login only')),(2, _('Flight Spotlight Read - Write')),(3, _('Flight Blender Read - Write')), (4, _('Aerobridge Read and Write')),(5, _('Permission Signing Client')),)
